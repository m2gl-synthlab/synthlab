...
public class CModuleEGTest {
	...
	/**
	 * Test method for
	 * {@link fr.istic.synthlab.controller.module.eg.CModuleEG#getPresentation()}
	 * .
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link fr.istic.synthlab.controller.module.eg.CModuleEG#p2cAttackChanged(double)}
	 * . Test de la méthode p2cAttackChanged lorsqu'on modifie une seule fois
	 * l'attaque
	 */
	 ...
	 * Test method for
	 * {@link fr.istic.synthlab.controller.module.eg.CModuleEG#p2cAttackChanged(double)}
	 * . Test de la méthode p2cAttackChanged lorsqu'on modifie deux fois
	 * l'attaque
	 */
	 ...
	 * Test method for
	 * {@link fr.istic.synthlab.controller.module.eg.CModuleEG#p2cAttackChanged(double)}
	 * . Test de la méthode p2cAttackChanged lorsqu'on modifie la valeur de
	 * l'attaque en dessous du minimum
	 */
	@Test
	 ...
	 * {@link fr.istic.synthlab.controller.module.eg.CModuleEG#p2cAttackChanged(double)}
	 * . Test de la méthode p2cAttackChanged lorsqu'on modifie la valeur de
	 * l'attaque en dessus du maximum
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link fr.istic.synthlab.controller.module.eg.CModuleEG#p2cDecayChanged(double)}
	 * . Test de la méthode p2cDecayChanged lorsqu'on modifie une seule fois le
	 * decay
	 */
	// TODO à voir pour les valeur => en expotentielle 2.00 = 1.9955
	@Test
	 ...
	 * Test method for
	 * {@link fr.istic.synthlab.controller.module.eg.CModuleEG#p2cDecayChanged(double)}
	 * . Test de la méthode p2cDecayChanged lorsqu'on modifie la valeur du decay
	...
	/**
	 * Test method for
	 * {@link fr.istic.synthlab.controller.module.eg.CModuleEG#p2cSustainChanged(double)}
	 ...
	 * Test method for
	 * {@link fr.istic.synthlab.controller.module.eg.CModuleEG#p2cSustainChanged(double)}
	 * . Test de la méthode p2cSustainChanged lorsqu'on modifie la valeur du
	 * sustain en dessous du minimum
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link fr.istic.synthlab.controller.module.eg.CModuleEG#p2cReleaseChanged(double)}
	 * .
	 */
	// TODO à voir pour les valeur => en expotentielle 2.00 = 1.9955
	@Test
	...
	/**
	 * Test method for
	 * {@link fr.istic.synthlab.controller.module.eg.CModuleEG#p2cClosing()}.
	...
	public void testP2cClosingAllWireConnected() {
		...
		try {
			wireIn.connect(iTest.getGateInput());
	...
	/**
	 * Test method for
	 * {@link fr.istic.synthlab.controller.module.eg.CModuleEG#setParameter(java.lang.String, java.lang.Double)}
	 * .
	 */
	@Test
	...
	public void testSetParameterFalseParameter() {
		double attack = iTest.getAttack(), decay = iTest.getDecay(), sustain = iTest.getSustain(), release = iTest.getRelease();
		iTest.setParameter("falseParameters", 2.0);
		assertEquals(attack, iTest.getAttack(), 4);
		assertEquals(decay, iTest.getDecay(), 4);
		assertEquals(sustain, iTest.getSustain(), 4);
		assertEquals(release, iTest.getRelease(), 4);
	}

	/**
	 * Test method for
	 * {@link fr.istic.synthlab.controller.module.eg.CModuleEG#getSynthesizerPresentation()}
	 * .
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link fr.istic.synthlab.controller.module.eg.CModuleEG#p2cRemoveModule(fr.istic.synthlab.controller.module.ICModule)}
	 * .
	 */
	@Test

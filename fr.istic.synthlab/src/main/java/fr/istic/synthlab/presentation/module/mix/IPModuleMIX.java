...
public interface IPModuleMIX extends IPModule {
	...
	/**
	 * Called by the controller to inform the presentation of the new gain 1
	 * value
	 * 
	 * @param gain
	 */
	...
	/**
	 * Called by the controller to inform the presentation of the new gain 2
	 * value
	 * 
	 * @param gain
	 */
	...
	/**
	 * Called by the controller to inform the presentation of the new gain 4
	 * value
	 * 
	 * @param gain
	 */

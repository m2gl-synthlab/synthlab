 ...
 * By Ioan Calapodescu 
 * From developpez.com
 * http://java.developpez.com/faq/gui/?page=jfilechooser#GRAPHIQUE_SWING_JFileChooser_francais
 */
import java.io.File; 
import java.util.*; 
import java.awt.*;
...
public class FilePreview extends JPanel implements PropertyChangeListener{
  ...
  private static final long serialVersionUID = -8210652642836274475L;
